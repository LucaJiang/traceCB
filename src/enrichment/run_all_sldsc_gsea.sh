...
STUDY_DIR="${STUDY_DIR:-${TRACECB_STUDY_DIR:-${REPO_ROOT}/results/EAS_eQTLGen}}"
GWAS_ROOT="${GWAS_ROOT:-${TRACECB_GWAS_DIR:-${REPO_ROOT}/data/gwas}}"
LDSC_DIR="${LDSC_DIR:-${REPO_ROOT}/external/ldsc}"
LDSC_L2_MAX_JOBS="${LDSC_L2_MAX_JOBS:-8}"
LDSC_H2_MAX_JOBS="${LDSC_H2_MAX_JOBS:-8}"
