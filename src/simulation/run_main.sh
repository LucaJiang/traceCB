...
# Curated simulation.py grid for the traceCB paper.
#
# Usage:
...
#     NREP=100 NSNP=2000 OMEGA_MODE=both bash src/simulation/run_main.sh
#
...
run_all_grids_for_omega() {
    ...
    echo "Running main 3 * power+ alpha grids with ${omega_name}"
