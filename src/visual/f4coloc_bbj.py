# %% plot fig 5 coloc heatmap for bcx mon
from utils import *

COLOC_THRESHOLD = 0.7
target_trait = "bbj_asthma"
# get annotation of gene id 2 name
cloest_protein_path = f"/Users/lucajiang/learn/CityU/XeQTL/data/coloc/{target_trait}/{target_trait}.closest.protein_coding.bed"
...
replicate_path = coloc_results_path_base + target_trait + "_replicate_tissue_coloc.csv"
...
for i, qtdid in enumerate(meta_data["QTDids"]):
    ...
    coloc_results_path = (
        coloc_results_path_base + f"{target_trait}_{qtdid}_{celltype}_coloc.csv"
    )
...
plt.tight_layout()
# plt.savefig(
#     f"{save_path}/coloc_{target_trait}_heatmap.png", dpi=300, bbox_inches="tight"
# )
# %%
